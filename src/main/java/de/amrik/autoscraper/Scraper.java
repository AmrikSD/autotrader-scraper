...
/** The main API interface. From this you should be able to get everything you want. */
class Scraper {

  // Unknowns, set to some random defaults :)
  ...
  /**
   * return the number of pages the user wants to search, this can be more than what will actually
   * be searched, if there are less pages on atotrader than the user wants..
   */
